...
export const utcTimestampSchema = z.string().refine(isValidUtcTimestamp, UTC_TIMESTAMP_MESSAGE);
...
export const customerPhoneSchema = z
  ...
  .refine((value) => normalizePolishPhone(value) !== null, CUSTOMER_PHONE_MESSAGE)
...
export const customerNotesSchema = z
  ...
  .optional()
  .transform((value): string | null => (value === undefined || value.length === 0 ? null : value));
