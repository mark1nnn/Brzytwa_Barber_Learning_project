...
каталогами, рабочими часами и блокировками без отдельной frontend-панели.
...
Этапы 1–10 завершены. Дальнейшие этапы могут расширять эксплуатационную
...
этапов 1, 2, 2.5, 3, 4, 5, 6, 7, 8, 9 и 10. `.gitattributes` предотвращает бессмысленные
