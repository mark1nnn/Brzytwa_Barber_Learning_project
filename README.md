...
Admin API, рабочая форма записи и рабочая административная панель ещё
отсутствуют.
...
`functions/api/public`. Admin routes ещё отсутствуют.
...
Этапы 1–7 завершены. Booking UI и admin API остаются для последующих этапов.

## Лицензия

Существующий файл `LICENSE` содержит Apache License 2.0 и не изменялся в рамках
этапов 1, 2, 2.5, 3, 4, 5, 6 и 7. `.gitattributes` предотвращает бессмысленные
